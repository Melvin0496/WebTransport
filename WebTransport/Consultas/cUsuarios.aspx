<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="cUsuarios.aspx.cs" Inherits="WebTransport.Consultas.cUsuarios" %>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2 col-sm-2 col-xs-3">
                                <asp:DropDownList ID="CamposDropDownList" runat="server" class="form-control input-sm btn-info">
                                    ...
                                    <asp:ListItem>TipoUsuario</asp:ListItem>
                                </asp:DropDownList>
                            </div>
