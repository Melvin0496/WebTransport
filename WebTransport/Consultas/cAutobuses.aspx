<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="cAutobuses.aspx.cs" Inherits="WebTransport.Consultas.cAutobuses" %>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-3">
                        <asp:DropDownList ID="CamposDropDownList" runat="server" class="form-control input-sm btn-info">
                            ...
                            <asp:ListItem>Cantidadpasajeros</asp:ListItem>
                        </asp:DropDownList>
                    </div>
                ...
                <div class="form-group">
                    <div class="col-md-8 col-md-offset-2 col-sm-4 col-xs-2">
                        <asp:GridView ID="DatosGridView" runat="server" class="table table-bordered table-hover table-striped table-responsive" AutoGenerateColumns="true">
                            <Columns>
                                <asp:HyperLinkField DataNavigateUrlFields="AutobusId" DataNavigateUrlFormatString="~/Registros/rAutobuses.aspx?Id={0}" Text="Editar" />
                            </Columns>
                        </asp:GridView>
                    </div>
                    <div class="col-md-1 col-sm-2 col-xs-4">
