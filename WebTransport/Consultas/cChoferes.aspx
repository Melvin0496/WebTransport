<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="cChoferes.aspx.cs" Inherits="WebTransport.Consultas.cChoferes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <div class="panel-heading">Consulta de Choferes</div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-3">
                        <asp:DropDownList ID="CamposDropDownList" runat="server" class="form-control input-sm btn-info">
                            ...
                            <asp:ListItem>AnosServicios</asp:ListItem>
                        </asp:DropDownList>
                    </div>
                ...
                <div class="form-group">
                    <div class="col-md-8 col-md-offset-2 col-sm-4 col-xs-2">
                        <asp:GridView ID="DatosGridView" runat="server" class="table table-bordered table-hover table-striped table-responsive" AutoGenerateColumns="true">
                            <Columns>
                                <asp:HyperLinkField DataNavigateUrlFields="ChoferId" DataNavigateUrlFormatString="~/Registros/rChoferes.aspx?Id={0}" Text="Editar" />
                            </Columns>
                        </asp:GridView>
                    </div>
                    <div class="col-md-1 col-sm-2 col-xs-4">
