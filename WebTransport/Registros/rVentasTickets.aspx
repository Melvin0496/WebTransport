<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="rVentasTickets.aspx.cs" Inherits="WebTransport.Registros.rVentasTickets" %>
                ...
                <asp:UpdatePanel runat="server">
                    <ContentTemplate>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <asp:TextBox ID="TipoEnvioTextBox" runat="server" Class="form-control input-sm"></asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2 col-md-pull-5">
                                <asp:GridView ID="EnviosGridView" runat="server" Class="table table-bordered table-hover table-striped"></asp:GridView>
                            </div>
                        </div>
            ...
            <asp:UpdatePanel runat="server">
                <ContentTemplate>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-1 col-md-pull-4 col-sm-2 col-xs-4">
                            <asp:Button ID="AgregarPasajerosButton" runat="server" class="btn btn-info btn-md" Text="Agregar" OnClick="AgregarPasajerosButton_Click" />
                        </div>
                        <%--<div class="col-md-1 col-sm-2 col-xs-4">
                        </div>--%>
                    </div>
